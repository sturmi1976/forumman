 ...
 */
class AddRecordToMenuProcessor3 implements DataProcessorInterface
{
    ...
    public function process(ContentObjectRenderer $cObj, array $contentObjectConfiguration, array $processorConfiguration, array $processedData)
    {
        ...
        if (isset($queryParams['tx_forumman_forumforumlist']['user'])) {
            $recordTable = 'fe_users';
            $recordUid = (int) $queryParams['tx_forumman_forumforumlist']['user'] ?? null;
        }
