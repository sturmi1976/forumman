 ...
 */
class AddRecordToMenuProcessor2 implements DataProcessorInterface
{
    ...
    public function process(ContentObjectRenderer $cObj, array $contentObjectConfiguration, array $processorConfiguration, array $processedData)
    {
        ...
        if (isset($queryParams['tx_forumman_forumforumlist']['post'])) {
            $recordTable = 'tx_forumman_domain_model_posts';
            $recordUid = (int) $queryParams['tx_forumman_forumforumlist']['post'] ?? null;
        }
    ...
    protected function addExtensionRecordToMenu(array $record, array &$menu)
    {
        ...
        $uri2 = \TYPO3\CMS\Core\Utility\GeneralUtility::getIndpEnv('REQUEST_URI');
